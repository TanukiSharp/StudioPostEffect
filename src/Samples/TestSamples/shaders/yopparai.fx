...
technique Yopparai
{
	...
	{
		VertexShader = null;
		PixelShader = compile ps_3_0 YopparaiFunc1();
	}

	pass Yopparai2
	{
		VertexShader = null;
		PixelShader = compile ps_3_0 YopparaiFunc2();
	}

	pass Yopparai3
	{
		VertexShader = null;
		PixelShader = compile ps_3_0 YopparaiFunc3();
	}

	pass Yopparai4
	{
		VertexShader = null;
		PixelShader = compile ps_3_0 YopparaiFunc4();
	}
}
